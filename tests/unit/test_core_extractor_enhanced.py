...
class TestEnhancedFileExtractor:
    ...
    def test_extract_files_saves_history(
        self, enhanced_extractor_with_mocks, settings_fixture, tmp_path
    ):
    ...
    def test_extract_files_with_abort_signal(
        self, enhanced_extractor_with_mocks, settings_fixture, tmp_path
    ):
    ...
    def test_extract_files_removes_empty_directories(
        self, enhanced_extractor_with_mocks, settings_fixture, tmp_path
    ):
            ...
            with patch("folder_extractor.core.extractor.ProgressTracker"):
                ...
                with patch(
                    ...
                    with patch.object(
                        ...
                        result = enhanced_extractor_with_mocks.extract_files(
                            files, destination
                        )
    ...
    def test_remove_empty_directories(self, enhanced_extractor_with_mocks, tmp_path):
        ...
        # Execute removal
        result = enhanced_extractor_with_mocks._remove_empty_directories(
            tmp_path, temp_files
        )
    ...
    def test_remove_empty_directories_respects_hidden_setting(
        self, enhanced_extractor_with_mocks, settings_fixture, tmp_path
    ):
    ...
    def test_remove_empty_directories_with_include_hidden(
        self, enhanced_extractor_with_mocks, settings_fixture, tmp_path
    ):
    ...
    def test_remove_empty_directories_with_temp_files(
        self, enhanced_extractor_with_mocks, tmp_path
    ):
    ...
    def test_remove_empty_directories_skips_inaccessible_directories(
        self, enhanced_extractor_with_mocks, tmp_path
    ):
    ...
    def test_remove_empty_directories_skips_undeletable_directories(
        self, enhanced_extractor_with_mocks, tmp_path
    ):
    ...
    def test_undo_with_abort_signal(self, enhanced_extractor_with_mocks, tmp_path):
        ...
        enhanced_extractor_with_mocks.mock_history_manager.load_history.return_value = (
            history_data
        )
    ...
    def test_undo_with_file_error(self, enhanced_extractor_with_mocks, tmp_path):
        ...
        # Mock ManagedOperation context manager
        mock_operation = Mock()
        mock_operation.abort_signal = (
            enhanced_extractor_with_mocks.abort_signal
        )  # Not set
        mock_operation.update_stats = Mock()
        mock_operation.__enter__ = Mock(return_value=mock_operation)
        mock_operation.__exit__ = Mock(return_value=False)
        ...
        assert (
            enhanced_extractor_with_mocks.mock_file_operations.move_file.call_count == 2
        )
    ...
    def test_undo_restores_deduplicated_file_by_copying(
        self, enhanced_extractor_with_mocks, tmp_path
    ):
    ...
    def test_undo_deduplicated_file_source_deleted(
        self, enhanced_extractor_with_mocks, tmp_path
    ):
        ...
        enhanced_extractor_with_mocks.mock_file_operations.move_file.side_effect = (
            FileNotFoundError(f"Source file not found: {missing_file_path}")
        )
    ...
    def test_undo_global_duplicate_by_copying(
        self, enhanced_extractor_with_mocks, tmp_path
    ):
    ...
    def test_undo_duplicate_updates_progress_correctly(
        self, enhanced_extractor_with_mocks, tmp_path
    ):
    ...
    def test_undo_duplicate_respects_abort_signal_mid_operation(
        self, enhanced_extractor_with_mocks, tmp_path
    ):
    ...
    def test_extract_files_dry_run_no_history(
        self, enhanced_extractor_with_mocks, settings_fixture, tmp_path
    ):
    ...
    def test_extract_files_no_history_when_no_files_moved(
        self, enhanced_extractor_with_mocks, settings_fixture, tmp_path
    ):
    ...
    def test_extract_files_sort_by_type_mode(
        self, enhanced_extractor_with_mocks, settings_fixture, tmp_path
    ):
    ...
    def test_extract_files_updates_operation_stats(
        self, enhanced_extractor_with_mocks, settings_fixture, tmp_path
    ):
...
class TestEnhancedFileExtractorIntegration:
    ...
    def test_remove_empty_directories_complete_workflow(
        self, enhanced_extractor_with_mocks, tmp_path
    ):
...
class TestEnhancedExtractionOrchestrator:
    ...
    def test_init_with_default_state_manager(
        self, orchestrator_with_mocks, settings_fixture
    ):
        ...
        orchestrator = EnhancedExtractionOrchestrator(
            extractor=orchestrator_with_mocks.mock_extractor
        )
    ...
    def test_execute_extraction_success(
        self, orchestrator_with_mocks, settings_fixture, tmp_path
    ):
        ...
        orchestrator_with_mocks.mock_state_manager.get_operation_stats.return_value = (
            mock_stats
        )
        ...
        orchestrator_with_mocks.mock_extractor.discover_files.assert_called_once_with(
            Path(source_path)
        )
    ...
    def test_execute_extraction_no_files(
        self, orchestrator_with_mocks, settings_fixture, tmp_path
    ):
    ...
    def test_execute_extraction_cancelled(
        self, orchestrator_with_mocks, settings_fixture, tmp_path
    ):
    ...
    def test_execute_extraction_dry_run_no_confirmation(
        self, orchestrator_with_mocks, settings_fixture, tmp_path
    ):
    ...
    def test_execute_extraction_security_error(
        self, orchestrator_with_mocks, settings_fixture, tmp_path
    ):
        ...
        orchestrator_with_mocks.mock_extractor.validate_security.side_effect = (
    ...
    def test_execute_extraction_generic_error(
        self, orchestrator_with_mocks, settings_fixture, tmp_path
    ):
    ...
    def test_execute_extraction_error_during_discovery(
        self, orchestrator_with_mocks, settings_fixture, tmp_path
    ):
        ...
        # Configure mocks
        orchestrator_with_mocks.mock_extractor.validate_security.return_value = None
        orchestrator_with_mocks.mock_extractor.discover_files.side_effect = Exception(
            "Discovery failed"
        )
    ...
    def test_execute_extraction_with_progress_callback(
        self, orchestrator_with_mocks, settings_fixture, tmp_path
    ):
    ...
    def test_execute_undo(self, orchestrator_with_mocks, tmp_path):
        ...
        # Configure mock
        orchestrator_with_mocks.mock_extractor.undo_last_operation.return_value = (
            expected_result
        )
        ...
        orchestrator_with_mocks.mock_extractor.undo_last_operation.assert_called_once_with(
            Path(path)
        )
...
class TestProcessSingleFile:
    ...
    def test_process_single_file_skips_discovery(
    ...
    def test_process_single_file_validates_security(
        self, orchestrator_with_mocks, tmp_path
    ):
    ...
    def test_process_single_file_respects_abort_signal(
        self, orchestrator_with_mocks, tmp_path
    ):
    ...
    def test_process_single_file_handles_nonexistent_file(
        self, orchestrator_with_mocks, tmp_path
    ):
    ...
    def test_process_single_file_passes_progress_callback(
        self, orchestrator_with_mocks, tmp_path
    ):
