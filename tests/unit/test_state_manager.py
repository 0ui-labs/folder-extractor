...
class TestOperationStats:
    ...
    def test_init(self):
        """Test initialization."""
        stats = OperationStats(operation_type="extraction", start_time=1000.0)
...
class TestStateManager:
    ...
    def test_state_values(self):
        ...
        self.manager.update_values({"key2": "value2", "key3": 123})
    ...
    def test_state_change_listener(self):
        ...
        mock_listener.assert_called_once_with(
            key="test_key", old_value=None, new_value="test_value"
        )
